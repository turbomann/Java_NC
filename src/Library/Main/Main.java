...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // вывести список книг в библиотеке
        // выдать книгу
        // забрать книгу
        // пользователь заппрашивает книгу
        // пользователь сдает книгу
        // пользователь просматривает список книг
        // пользователь имеет историю книг
